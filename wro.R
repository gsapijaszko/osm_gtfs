...
head(gtfs_routes)
dbWriteTable(con, "gtfs_routes", gtfs_routes)
res = dbGetQuery(con, "SELECT * FROM gtfs_routes WHERE route_id = '109' AND stop_sequence = 0 AND lower(stop_name) = 'pl. solidarności'")
print(res)
rm(gtfs_routes)
